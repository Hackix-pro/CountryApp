    ...
    <Layout title="Dashboard">
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 text-white shadow-lg">
          ...
          <p className="text-blue-100">Manage your shared expenses with ease</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Button
            ...
            className="bg-gray-600 hover:bg-gray-700 text-white py-3 rounded-lg flex items-center justify-center gap-2 transition-colors"
          >
            View Profile
          </Button>
        </div>
        ...
        {/* Groups Section */}
        <div>
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Your Groups</h3>
